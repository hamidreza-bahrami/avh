...
def show_page():
    st.write("<h1 style='text-align: center; color: blue;'>مدل تشخیص انسان از حیوان</h1>", unsafe_allow_html=True)
            ...
            if y_pred == 1:
                with st.chat_message("assistant"):
                    with st.spinner('''در حال تحلیل'''):
                        ...
                        st.write("<h4 style='text-align: right; color: gray;'>بر اساس تحلیل من، تصویر وارد شده انسان است</h4>", unsafe_allow_html=True)
            elif y_pred == 0:
                with st.chat_message("assistant"):
                    with st.spinner('''در حال تحلیل'''):
                        time.sleep(3)
                        st.success(u'\u2713''تحلیل انجام شد')
                        st.write("<h4 style='text-align: right; color: gray;'>بر اساس تحلیل من، تصویر وارد شده حیوان است</h4>", unsafe_allow_html=True)
